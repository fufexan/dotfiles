{
  ...
  config = ''
    ...
    exec-once=swayidle -w timeout 300 "hyprctl dispatch dpms off" resume "hyprctl dispatch dpms on" timeout 310 "swaylock" timeout 600 "systemctl suspend" before-sleep swaylock lock swaylock
