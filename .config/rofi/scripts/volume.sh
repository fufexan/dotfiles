...
case $chosen in
    $ICON_UP)
        pulsemixer --unmute --change-volume +5 && notify-send -u low -t 1500 "Volume Up $ICON_UP"
        ;;
    $ICON_DOWN)
        pulsemixer --unmute --change-volume -5 && notify-send -u low -t 1500 "Volume Down $ICON_DOWN"
        ;;
    $ICON_MUTED)
